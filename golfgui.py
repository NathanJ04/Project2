...
"")
        ...
        self.label_total_score.setGeometry(QtCore.QRect(430, 340, 131, 41))
        font = QtGui.QFont()
        ...
        self.label_total_back = QtWidgets.QLabel(parent=self.page_post_score)
        self.label_total_back.setGeometry(QtCore.QRect(310, 340, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_total_back.setFont(font)
        self.label_total_back.setTextFormat(QtCore.Qt.TextFormat.AutoText)
        self.label_total_back.setObjectName("label_total_back")
        self.label_total_front = QtWidgets.QLabel(parent=self.page_post_score)
        self.label_total_front.setGeometry(QtCore.QRect(170, 340, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_total_front.setFont(font)
        self.label_total_front.setTextFormat(QtCore.Qt.TextFormat.AutoText)
        self.label_total_front.setObjectName("label_total_front")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_total_back.setText(_translate("Dialog", "BACK: N/A"))
        self.label_total_front.setText(_translate("Dialog", "FRONT: N/A"))
